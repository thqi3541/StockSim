...
class RegistrationInteractorTest {
    ...
    void successTest() throws Exception {
        ...
        RegistrationInteractor interactor =
                new RegistrationInteractor(outputPresenter, dataAccess);
    ...
    void emptyUsernameTest() {
        RegistrationInputData inputData =
                new RegistrationInputData("", "Password123!", "Password123!");
        ...
        verify(outputPresenter).prepareInvalidInputView(
    ...
    void emptyPasswordTest() {
        RegistrationInputData inputData =
                new RegistrationInputData("newuser", "", "");
    ...
    void passwordsDoNotMatchTest() {
        RegistrationInputData inputData =
                new RegistrationInputData("newuser", "Password123!",
                                          "DifferentPassword!");
        ...
        verify(outputPresenter).preparePasswordsDoNotMatchView(
    ...
    void weakPasswordTest() {
        RegistrationInputData inputData =
                new RegistrationInputData("newuser", "weakpass", "weakpass");
    ...
    void invalidUsernameShortTest() {
        RegistrationInputData inputData =
                new RegistrationInputData("usr", "Password123!",
                                          "Password123!");
    ...
    void invalidUsernameSpecialCharsTest() {
        RegistrationInputData inputData =
                new RegistrationInputData("user@name", "Password123!",
                                          "Password123!");
    ...
    void restrictedUsernameTest() {
        RegistrationInputData inputData =
                new RegistrationInputData("adminUser", "Password123!",
                                          "Password123!");
    ...
    void duplicateUsernameTest() throws DocumentParsingException {
        ...
        String confirmPassword = "Password123!";
        RegistrationInputData inputData =
                new RegistrationInputData(existingUsername, password,
                                          confirmPassword);

        // Mock data access to indicate that the user already exists
        when(dataAccess.hasUsername(existingUsername)).thenReturn(false)
                                                      .thenReturn(true);
        ...
        verify(outputPresenter).prepareDuplicateUsernameView(
