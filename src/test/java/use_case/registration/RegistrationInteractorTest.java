...
class RegistrationInteractorTest {
    ...
    void successTest() throws Exception {
        ...
        verify(outputPresenter)
                .prepareSuccessView(new RegistrationOutputData("Registration successful! Please log in."));
    }
    ...
    void invalidUsernameShortTest() {
        RegistrationInputData inputData = new RegistrationInputData("usr", "Password123!", "Password123!");
        ...
        verify(outputPresenter).prepareInvalidUsernameView("Username must be at least 5 characters long.");
    }

    @Test
    void invalidUsernameLongTest() {
        RegistrationInputData inputData =
                new RegistrationInputData("thisisaverylongusernameexceedinglimit", "Password123!", "Password123!");
        ...
        // Verify that invalid username view is prepared
        verify(outputPresenter).prepareInvalidUsernameView("Username must be between 5 and 20 characters.");
    }

    @Test
    void invalidUsernameSpecialCharsTest() {
        RegistrationInputData inputData = new RegistrationInputData("user@name", "Password123!", "Password123!");
        ...
        // Verify that invalid username view is prepared
        verify(outputPresenter)
                .prepareInvalidUsernameView(
                        "Username must start with a letter and contain only letters, digits, or underscores.");
    }

    @Test
    void restrictedUsernameTest() {
        RegistrationInputData inputData = new RegistrationInputData("adminUser", "Password123!", "Password123!");
        ...
        // Verify that invalid username view is prepared
        verify(outputPresenter)
                .prepareInvalidUsernameView("Username cannot contain restricted words such as 'admin' or 'root'.");
    }
