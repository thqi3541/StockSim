...
public class ReflectionMongoDBDocumentParserTest {
  ...
  public void testTransactionSerialization() throws DocumentParsingException {
    ...
    Transaction parsedTransaction = ReflectionMongoDBDocumentParser.fromDocument(transactionDoc,
        Transaction.class);
  ...
  public void testUserStockSerialization() throws DocumentParsingException {
    ...
    UserStock parsedUserStock = ReflectionMongoDBDocumentParser.fromDocument(userStockDoc,
        UserStock.class);
  ...
  public void testPortfolioSerialization() throws DocumentParsingException {
    // Arrange
    UserStock userStock1 = new UserStock(new Stock("META", "Meta Platforms", "Technology", 350.0),
        300.0, 10);
    UserStock userStock2 = new UserStock(new Stock("NFLX", "Netflix", "Streaming", 400.0), 380.0,
        15);
    ...
    Portfolio parsedPortfolio = ReflectionMongoDBDocumentParser.fromDocument(portfolioDoc,
        Portfolio.class);
