 ...
 *
 * <p>It uses {@link UserMapper} for converting between the {@link User} entity and
 * {@link UserDTO}, and {@link MongoDBDocumentParser} for handling the lower-level serialization and
 * deserialization between {@link Document} and the {@link UserDTO}.
 */
