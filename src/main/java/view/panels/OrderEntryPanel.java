...
public class OrderEntryPanel extends JPanel implements IComponent {
    ...
    private JPanel createInputPanel() {
        ...
        tickerInput.setMaximumSize(
                new Dimension(Integer.MAX_VALUE, tickerInput.getPreferredSize().height));
        ...
        quantityInput.setMaximumSize(
                new Dimension(Integer.MAX_VALUE, quantityInput.getPreferredSize().height));
    ...
    private void handleBuyAction() {
        ...
        // Execute buy action
        ExecuteBuyController controller =
                ServiceManager.Instance().getService(ExecuteBuyController.class);
